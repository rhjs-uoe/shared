...
%{ fix I J a b c d
%  assume "I = interval a b" "J = interval c d"
%  |\tikzmark{startd}|{ assume |\tikzmark{startd1}|"betw4 a b c d"|\tikzmark{endd1}|
%    have "I\<inter>J = {}" (*...*)
%  } { assume |\tikzmark{startd2}|"betw4 a c b d"|\tikzmark{endd2}|
%    have "I\<inter>J = interval c b" (*...*)
%  } { assume |\tikzmark{startd3}|"betw4 a c d b"|\tikzmark{endd3}|
%    have "I\<inter>J = interval c d" (*...*)|\tikzmark{endd}|
%  } }
...
%					([shift={(-3pt,1.65ex)}]pic cs:startd1)
%					  rectangle
%					([shift={(3pt,-.65ex)}]pic cs:endd1);
%			\end{tikzpicture}
%			\begin{tikzpicture}[remember picture,overlay]
%				\draw[blue,rounded corners]
%					([shift={(-3pt,1.65ex)}]pic cs:startd2)
%					  rectangle
%					([shift={(3pt,-.65ex)}]pic cs:endd2);
%			\end{tikzpicture}
%			\begin{tikzpicture}[remember picture,overlay]
%				\draw[blue,rounded corners]
%					([shift={(-3pt,1.65ex)}]pic cs:startd3)
%					  rectangle
%					([shift={(3pt,-.65ex)}]pic cs:endd3);
%			\end{tikzpicture}
%		}
%	\end{columns}
\end{frame}
